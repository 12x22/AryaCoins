...
module.exports.run = async(CLIENT, message, ARGS, PREFIXARRAY) => {
    ...
    if(argent < 25.00) return message.channel.send(`<@${message.author.id}>, le montant minimum pour une transaction est de **25.00** ***AR$*** !`);
    ...
    //* || [VARIABLE] || *//
        ...
        message.channel.send(`<@${message.author.id}>, la transaction de **${argent}** ***AR$*** à été effectué ! ✅`)
